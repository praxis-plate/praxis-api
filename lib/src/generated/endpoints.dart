...
import '../endpoints/course_admin_endpoint.dart' as _i6;
import '../endpoints/course_analytics_admin_endpoint.dart' as _i7;
import '../endpoints/course_endpoint.dart' as _i8;
import '../endpoints/email_idp_endpoint.dart' as _i9;
import '../endpoints/external_integration_admin_endpoint.dart' as _i10;
import '../endpoints/health_endpoint.dart' as _i11;
import '../endpoints/jwt_refresh_endpoint.dart' as _i12;
import '../endpoints/lesson_admin_endpoint.dart' as _i13;
import '../endpoints/lesson_endpoint.dart' as _i14;
import '../endpoints/module_admin_endpoint.dart' as _i15;
import '../endpoints/module_endpoint.dart' as _i16;
import '../endpoints/task_admin_endpoint.dart' as _i17;
import '../endpoints/task_endpoint.dart' as _i18;
import '../endpoints/user_statistics_endpoint.dart' as _i19;
import '../endpoints/wallet_endpoint.dart' as _i20;
import 'package:praxis_server/src/generated/enums/user_role.dart' as _i21;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'courseAdmin': _i6.CourseAdminEndpoint()
        ..initialize(
          server,
          'courseAdmin',
          null,
        ),
      'courseAnalyticsAdmin': _i7.CourseAnalyticsAdminEndpoint()
        ..initialize(
          server,
          'courseAnalyticsAdmin',
          null,
        ),
      'course': _i8.CourseEndpoint()
        ..initialize(
          server,
          'course',
          null,
      ...
      'externalIntegrationAdmin': _i10.ExternalIntegrationAdminEndpoint()
        ..initialize(
          server,
          'externalIntegrationAdmin',
          null,
        ),
      'health': _i11.HealthEndpoint()
        ..initialize(
          server,
          'health',
          null,
        ),
      'jwtRefresh': _i12.JwtRefreshEndpoint()
        ..initialize(
          server,
          'jwtRefresh',
          null,
        ),
      'lessonAdmin': _i13.LessonAdminEndpoint()
        ..initialize(
          server,
          'lessonAdmin',
          null,
        ),
      'lesson': _i14.LessonEndpoint()
        ..initialize(
          server,
          'lesson',
          null,
        ),
      'moduleAdmin': _i15.ModuleAdminEndpoint()
        ..initialize(
          server,
          'moduleAdmin',
          null,
        ),
      'module': _i16.ModuleEndpoint()
        ..initialize(
          server,
          'module',
          null,
        ),
      'taskAdmin': _i17.TaskAdminEndpoint()
        ..initialize(
          server,
          'taskAdmin',
          null,
      ...
      'userStatistics': _i19.UserStatisticsEndpoint()
        ..initialize(
          server,
          'userStatistics',
          null,
      ...
      methodConnectors: {
        'generateHint': _i1.MethodConnector(
          ...
          params: {
            'request': _i1.ParameterDescription(
              name: 'request',
              type: _i1.getType<_i22.GenerateHintRequest>(),
              nullable: false,
            ),
          },
          call:
        ...
        'generateExplanation': _i1.MethodConnector(
          ...
          params: {
            'request': _i1.ParameterDescription(
              name: 'request',
              type: _i1.getType<_i23.GenerateExplanationRequest>(),
              nullable: false,
            ),
          },
          call:
      ...
      methodConnectors: {
        'list': _i1.MethodConnector(
          ...
          params: {
            'status': _i1.ParameterDescription(
              name: 'status',
              type: _i1.getType<_i24.ContentStatus?>(),
              nullable: true,
            ),
            'query': _i1.ParameterDescription(
              name: 'query',
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['courseAdmin'] as _i6.CourseAdminEndpoint).list(
                    session,
        ...
        'create': _i1.MethodConnector(
          ...
          params: {
            'request': _i1.ParameterDescription(
              name: 'request',
              type: _i1.getType<_i25.CreateCourseRequest>(),
              nullable: false,
            ),
          },
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['courseAdmin'] as _i6.CourseAdminEndpoint).create(
                    session,
                    params['request'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['courseAdmin'] as _i6.CourseAdminEndpoint).update(
                    session,
                    params['request'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['courseAdmin'] as _i6.CourseAdminEndpoint).publish(
                    session,
                    params['courseId'],
                  ),
        ),
              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['courseAnalyticsAdmin']
                          as _i7.CourseAnalyticsAdminEndpoint)
                      .getDashboard(
                        session,
                        params['courseId'],
        ...
        'get': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['course'] as _i8.CourseEndpoint).get(
                session,
                limit: params['limit'],
                offset: params['offset'],
              ),
        ...
        'getById': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['course'] as _i8.CourseEndpoint).getById(
                session,
                params['courseId'],
              ),
        ),
        'getEnrolled': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['course'] as _i8.CourseEndpoint)
                  .getEnrolled(session),
        ),
        'enroll': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['course'] as _i8.CourseEndpoint).enroll(
                session,
                params['courseId'],
              ),
        ),
        'unenroll': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['course'] as _i8.CourseEndpoint).unenroll(
                session,
                params['courseId'],
              ),
        ),
              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['externalIntegrationAdmin']
                          as _i10.ExternalIntegrationAdminEndpoint)
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['health'] as _i11.HealthEndpoint).ping(session),
        ),
      },
    );
        ...
        'refreshAccessToken': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['jwtRefresh'] as _i12.JwtRefreshEndpoint)
                  .refreshAccessToken(
                    session,
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['lessonAdmin'] as _i13.LessonAdminEndpoint).list(
                    session,
                    params['moduleId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['lessonAdmin'] as _i13.LessonAdminEndpoint).create(
                    session,
                    params['request'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['lessonAdmin'] as _i13.LessonAdminEndpoint).update(
                    session,
                    params['request'],
                  ),
        ),
        'reorder': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['lessonAdmin'] as _i13.LessonAdminEndpoint)
                  .reorder(
                    session,
                    params['request'],
                  ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['lesson'] as _i14.LessonEndpoint).getByCourseId(
                    session,
                    params['courseId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['lesson'] as _i14.LessonEndpoint).getByModuleId(
                    session,
                    params['moduleId'],
                  ),
        ),
        'getById': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['lesson'] as _i14.LessonEndpoint).getById(
                session,
                params['lessonId'],
              ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['lesson'] as _i14.LessonEndpoint).markComplete(
                    session,
                    params['lessonId'],
        ...
        'complete': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['lesson'] as _i14.LessonEndpoint).complete(
                session,
                params['request'],
              ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['moduleAdmin'] as _i15.ModuleAdminEndpoint).list(
                    session,
                    params['courseId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['moduleAdmin'] as _i15.ModuleAdminEndpoint).create(
                    session,
                    params['request'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['moduleAdmin'] as _i15.ModuleAdminEndpoint).update(
                    session,
                    params['request'],
                  ),
        ),
        'reorder': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['moduleAdmin'] as _i15.ModuleAdminEndpoint)
                  .reorder(
                    session,
                    params['request'],
                  ),
        ...
        'get': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['module'] as _i16.ModuleEndpoint).get(
                session,
                params['courseId'],
              ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['taskAdmin'] as _i17.TaskAdminEndpoint).list(
                    session,
                    params['lessonId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['taskAdmin'] as _i17.TaskAdminEndpoint).create(
                    session,
                    params['request'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['taskAdmin'] as _i17.TaskAdminEndpoint).update(
                    session,
                    params['request'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['taskAdmin'] as _i17.TaskAdminEndpoint).reorder(
                    session,
                    params['request'],
                  ),
        ),
        'upsertOptions': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['taskAdmin'] as _i17.TaskAdminEndpoint)
                  .upsertOptions(
                    session,
                    params['request'],
                  ),
        ...
        'getById': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['task'] as _i18.TaskEndpoint).getById(
                session,
                params['taskId'],
              ),
        ),
        'getByLessonId': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['task'] as _i18.TaskEndpoint).getByLessonId(
                session,
                params['lessonId'],
              ),
        ),
        'answer': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['task'] as _i18.TaskEndpoint).answer(
                session,
                params['taskId'],
                params['userAnswer'],
              ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['userStatistics'] as _i19.UserStatisticsEndpoint)
                      .get(session),
        ),
      },
    );
        ...
        'topUp': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['wallet'] as _i20.WalletEndpoint).topUp(
                session,
                params['request'],
              ),
        ),
        'buy': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['wallet'] as _i20.WalletEndpoint).buy(
                session,
                params['request'],
              ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['wallet'] as _i20.WalletEndpoint).getHistory(
                    session,
                    limit: params['limit'],
                    offset: params['offset'],
                  ),
