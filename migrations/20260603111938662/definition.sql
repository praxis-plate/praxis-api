...
--
-- Class Achievement as table achievement
--
...
-- Indexes
CREATE INDEX "achievement_condition_idx" ON "achievement" USING btree ("conditionType");

--
-- Class CoinTransaction as table coin_transaction
--
...
-- Indexes
CREATE INDEX "course_category_idx" ON "course" USING btree ("category");
CREATE INDEX "course_rating_idx" ON "course" USING btree ("rating");
...
CREATE TABLE "lesson" (
    ...
    "durationMinutes" bigint NOT NULL,
    "completionXp" bigint NOT NULL,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL
);

-- Indexes
CREATE INDEX "lesson_module_id_idx" ON "lesson" USING btree ("moduleId");
CREATE INDEX "lesson_module_id_order_idx" ON "lesson" USING btree ("moduleId", "orderIndex");

--
-- Class LessonProgress as table lesson_progress
--
...
-- Indexes
CREATE INDEX "lesson_progress_auth_user_id_idx" ON "lesson_progress" USING btree ("authUserId");
CREATE UNIQUE INDEX "lesson_progress_auth_user_id_lesson_id_unique" ON "lesson_progress" USING btree ("authUserId", "lessonId");
...
-- Indexes
CREATE INDEX "module_course_id_idx" ON "module" USING btree ("courseId");
CREATE INDEX "module_course_id_order_idx" ON "module" USING btree ("courseId", "orderIndex");
...
-- Indexes
CREATE INDEX "task_lesson_id_idx" ON "task" USING btree ("lessonId");
CREATE INDEX "task_lesson_id_order_idx" ON "task" USING btree ("lessonId", "orderIndex");

--
-- Class TaskAnswerAttempt as table task_answer_attempt
--
...
--
-- Class TaskOption as table task_option
--
...
-- Indexes
CREATE INDEX "task_option_task_id_idx" ON "task_option" USING btree ("taskId");
CREATE INDEX "task_option_task_id_order_idx" ON "task_option" USING btree ("taskId", "orderIndex");

--
-- Class TaskTestCase as table task_test_case
--
...
-- Indexes
CREATE INDEX "task_test_case_task_id_idx" ON "task_test_case" USING btree ("taskId");
CREATE INDEX "task_test_case_task_id_order_idx" ON "task_test_case" USING btree ("taskId", "orderIndex");

--
-- Class UserAchievement as table user_achievement
--
...
-- Indexes
CREATE INDEX "user_achievement_auth_user_id_idx" ON "user_achievement" USING btree ("authUserId");
CREATE UNIQUE INDEX "user_achievement_auth_user_id_achievement_id_unique" ON "user_achievement" USING btree ("authUserId", "achievementId");

--
-- Class UserCourse as table user_course
--
...
-- Indexes
CREATE INDEX "user_course_auth_user_id_idx" ON "user_course" USING btree ("authUserId");
CREATE UNIQUE INDEX "user_course_auth_user_id_course_id_unique" ON "user_course" USING btree ("authUserId", "courseId");

--
-- Class UserProfileMetadata as table user_profile_metadata
--
CREATE TABLE "user_profile_metadata" (
    "id" bigserial PRIMARY KEY,
    "authUserId" uuid NOT NULL,
    "lastFullNameChangedAt" timestamp without time zone
);

-- Indexes
CREATE UNIQUE INDEX "user_profile_metadata_auth_user_id_unique" ON "user_profile_metadata" USING btree ("authUserId");

--
-- Class UserStatistics as table user_statistics
--
...
--
-- Class UserWallet as table user_wallet
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('praxis', '20260603111938662', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260603111938662', "timestamp" = now();
