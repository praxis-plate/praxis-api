...
- **Виртуальный кошелёк** – монеты и история транзакций
...
- **Services** инкапсулируют доменную логику и агрегируют данные из нескольких data sources
- **Data Sources** напрямую взаимодействуют с таблицами Postgres
- **Validation** применяется на границах (валидация входных данных, бизнес-правила)
...
Это образовательный проект. Все права защищены.
