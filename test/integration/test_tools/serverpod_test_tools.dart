...
import 'package:praxis_server/src/generated/responses/ai_response.dart' as _i4;
...
class _AiEndpoint {
  ...
  _i3.Future<_i4.AiResponse> generateHint(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.GenerateHintRequest request,
  ) async {
  ...
  _i3.Future<_i4.AiResponse> generateExplanation(
    _i1.TestSessionBuilder sessionBuilder,
...
class _UserStatisticsEndpoint {
  ...
  _i3.Future<_i8.UserStatisticsDto> get(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.UserStatisticsDto>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _WalletEndpoint {
  ...
  _i3.Future<_i9.UserWallet> getBalance(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
  ...
  _i3.Future<_i10.CoinTransactionDto> topUp(
    _i1.TestSessionBuilder sessionBuilder,
    _i11.CreateCoinTransactionRequest request,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i10.CoinTransactionDto>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i10.CoinTransactionDto> buy(
    _i1.TestSessionBuilder sessionBuilder,
    _i11.CreateCoinTransactionRequest request,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i10.CoinTransactionDto>> getHistory(
    _i1.TestSessionBuilder sessionBuilder, {
    int? limit,
    int? offset,
  }) async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i10.CoinTransactionDto>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
